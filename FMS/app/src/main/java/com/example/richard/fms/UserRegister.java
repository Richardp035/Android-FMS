...
public class UserRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd=new DatePickerDialog(UserRegister.this, mDateSetListener,yy,mm,dd);
                dpd.show();
    ...
    public void ToRegister(View v) {
        ...
        if(namestr.equals(""))
            ...
            phno.setError("Incorrect Format (or) Phone Number Should Contain Minimium 10 Digit");
            ...
            if (!passstr.equals(cpassstr))
                ...
                boolean val = dh.insertuser(namestr,phnostr,dobstr,addressstr,streetstr,citystr,statestr,zipcodestr,
                        genderstr,passstr);
                if (val) {
                    Toast.makeText(this, "Inserted Successfull", Toast.LENGTH_SHORT).show();
                    Intent show=new Intent(this,Login.class);
                    startActivity(show);
                    finish();
                }
                else
