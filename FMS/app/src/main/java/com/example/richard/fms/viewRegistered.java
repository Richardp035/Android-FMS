...
public class viewRegistered extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cs=userdb.viewdata(sqldb);
        if(cs.moveToFirst()){
            do{
        ...
        lsve.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parant, final View view, int position, long id){
                ...
                Cursor  vReg=userdb.viewregistered(selected_list, sqldb);
                StringBuffer buff=new StringBuffer();
                while(vReg.moveToNext()){
                    buff.append("Name\t:\t"+vReg.getString(0)+"\n");
                    buff.append("Phone Number\t:\t"+vReg.getString(1)+"\n");
                    buff.append("DOB\t:\t"+vReg.getString(2)+"\n");
                    buff.append("Address\t:\t"+vReg.getString(3)+"\n");
                    buff.append("Street\t:\t"+vReg.getString(4)+"\n");
                    buff.append("City\t:\t"+vReg.getString(5)+"\n");
                    buff.append("State\t:\t"+vReg.getString(6)+"\n");
                    buff.append("Postal Code\t:\t"+vReg.getString(7)+"\n");
                    buff.append("Gender\t:\t"+vReg.getString(8)+"\n");
                    buff.append("Password\t:\t"+vReg.getString(9)+"\n");
                    buff.append("Type\t:\t"+vReg.getString(10)+"\n");

                    //Alert Dialog
                    final AlertDialog.Builder builder=new AlertDialog.Builder(viewRegistered.this);
                    builder.setCancelable(true);
                    builder.setTitle("Registered Details");
                    ...
                    builder.setNegativeButton("Update", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            Intent phno=new Intent(getBaseContext(),updateRegister.class);
                            phno.putExtra("",selected_list);
                            startActivity(phno);
                        }
                    });
                    builder.show();
